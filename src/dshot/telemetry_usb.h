...
#define TELEMETRY_TYPE_ESC_VERSION_DISCOVERY_COMPLETE 8
// Board-level reports use global motor IDs 0/4 and signed milliamps; -1 is unavailable.
#define TELEMETRY_TYPE_CALIBRATED_BOARD_CURRENT 9
#define TELEMETRY_TYPE_CURRENT_BASELINE 10
